...
//    Route::get('/smpt', [SmptController::class, 'index'])->name('smpt');
    ...
    Route::get('/language/list', [LanguageController::class, 'getLanguageList'])->name('language.getlist');
    Route::put('/language/list/{id}', [LanguageController::class, 'updateLanguage'])->name('language.update');
    Route::delete('/language/list/{id}', [LanguageController::class, 'deleteLanguage'])->name('language.delete');
    // end language
