<div>
    ...
    <form wire:submit.prevent="save" enctype="multipart/form-data">
        <div class="w-full flex flex-wrap mb-4 border-b border-gray-300 pb-4">
        ...
        <div class="mt-5 flex flex-wrap mb-4 border-b border-gray-300 pb-4">
            <div class="lg:w-1/2 sm:w-full px-2">
            ...
            <div class="lg:w-1/2 sm:w-full px-2">
                <div class="flex flex-col">
                    <div class="w-1/2">
                        @if ($favicon != null)
                            <img src="{{ asset('images/' . $favicon) }}" id="faviconImg"
                                 style="width: 200px; height: 150px;">
                        @else
                            <img src="https://via.placeholder.com/250x150?text=Placeholder+Image" id="faviconImg"
                                 style="width: 200px; height: 150px;">
                        @endif
                    </div>
                    <div class="w-3/4">
        ...
        <div class="w-full flex flex-wrap mb-4 border-b border-gray-300 pb-4">
            ...
            <div class="lg:w-1/2 sm:w-full px-2">
                ...
                <x-input wire:model="social_instagram" type="text" id="social_instagram" name="social_instagram" />
        ...
        <div class="w-full mb-4 border-b border-gray-300 pb-4">
            <div class="mb-4 px-2">
        ...
        <div class="w-full flex flex-wrap mb-4 border-b border-gray-300 pb-4">
            <div class="sm:w-1/2 mb-4 px-2">
                ...
                <x-checkbox name="enableRegistrationTerms" id="enableRegistration                Terms" wire:model="enableRegistrationTerms" />
            </div>
            <div class="sm:w-1/2 mb-4 px-2">
        ...
        <div class="flex flex-wrap mb-4 border-b border-gray-300 pb-4">
            <div class="lg:w-1/2 sm:w-full px-2">
            ...
            <div class="lg:w-1/2 sm:w-full px-2">
                ...
                <x-input wire:model="currency_symbol" type="text" id="currency_symbol" name="currency_symbol" />
        ...
        <div class="flex flex-wrap mb-4 border-b border-gray-300 pb-4">
            <div class="lg:w-1/2 sm:w-full px-2">
                <x-label for="paypal_client_id" :value="__('PayPal Client ID')" />
                <x-input wire:model="paypal_client_id" type="text" id="paypal_client_id" name="paypal_client_id" />
                <x-input-error for="paypal_client_id" :messages="$errors->first('paypal_client_id')" />
            </div>
            <div class="lg:w-1/2 sm:w-full px-2">
                <x-label for="paypal_client_secret" :value="__('PayPal Client Secret')" />
                <x-input wire:model="paypal_client_secret" type="text" id="paypal_client_secret"
                         name="paypal_client_secret" />
                <x-input-error for="paypal_client_secret" :messages="$errors->first('paypal_client_secret')" />
            </div>
        </div>
